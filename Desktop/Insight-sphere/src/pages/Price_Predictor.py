...
pages_dir = current_file_path.parent
src_dir = pages_dir.parent
root_dir = src_dir.parent
sys.path.append(str(root_dir))


model_path = os.path.join(root_dir, 'models', 'pipeline.pkl')
df_path = os.path.join(root_dir, 'models', 'df.pkl')
